...
const NAV_BY_ROLE: Record<UserRole, NavItem[]> = {
  ADMIN: [
    ...
    { label: "Engagement & Comms", href: "/admin/engagement", icon: Sparkles },
    { label: "Mentor Ops", href: "/admin/mentors", icon: ShieldAlert },
    ...
    { label: "Rules Engine", href: "/admin/settings", icon: Settings },
  ...
  MENTOR_MANAGER: [
    ...
    { label: "Engagement & Comms", href: "/mentor-manager/engagement", icon: Sparkles },
    { label: "Mentor List", href: "/mentor-manager/mentors", icon: Users },
