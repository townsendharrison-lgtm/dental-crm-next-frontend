...
export default function MentorInboxPage() {
  ...
  // Load Directory Users: Assigned Students + Other Mentors / Admins
  const loadDirectoryUsers = async () => {
    if (!currentUserId) return;
    try {
      const merged: DirectoryUser[] = [];

      // 1. Fetch student list assigned to this mentor
      ...
      // 2. Fetch mentors and administrators list
      ...
      // Filter out self and duplicate records
        ...
        <div className="w-80 border-r border-slate-800 flex flex-col bg-slate-950/50 backdrop-blur-xl z-20 shrink-0">
          <div className="p-6 border-b border-slate-800/60">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-black text-white tracking-tight">Student Inbox</h2>
              <button
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex justify-between items-center mb-0.5">
                        <h4 className="font-bold text-sm text-slate-200 truncate group-hover:text-white transition-colors">
                          {c.is_group ? c.name || "Group Chat" : otherParticipant?.name || "Secure Chat"}
                        </h4>
                      </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-slate-500 font-bold uppercase tracking-wider mt-0.5">
                      {activeConversation.is_group ? "Group Mentorship" : displayParticipants[0]?.role}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div ref={messagesContainerRef} className="flex-1 px-6 py-6 overflow-y-auto custom-scrollbar flex flex-col gap-3 bg-slate-950/10">
                {loadingMsgs ? (
                  ...
                  <div className="flex-1 flex flex-col items-center justify-center text-slate-600">
                    <p className="text-sm">No messages. Type below to start messaging!</p>
                  </div>
                ) : (
                    ...
                    {isGroup && (
                      <div className="space-y-1">
                        ...
                        <input
                          ...
                          placeholder="e.g. Group Mentorship Name"
